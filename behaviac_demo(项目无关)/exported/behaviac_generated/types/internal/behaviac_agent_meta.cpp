...
namespace behaviac
{
	...
	public:
		...
		virtual bool load()
		{
			AgentMeta::SetTotalSignature(2659372140u);
			...
			// monster_id1
			meta = BEHAVIAC_NEW AgentMeta(3040475436u);
			AgentMeta::GetAgentMetas()[2730094828u] = meta;
			meta->RegisterMethod(1045109914u, BEHAVIAC_NEW CAgentStaticMethodVoid_1<char*>(FunctionPointer_monster_id1_LogMessage));
			meta->RegisterMethod(1505908390u, BEHAVIAC_NEW CAgentMethodVoid(FunctionPointer_monster_id1_SayHello));
			meta->RegisterMethod(2521019022u, BEHAVIAC_NEW CMethod_behaviac_Agent_VectorAdd());
			meta->RegisterMethod(2306090221u, BEHAVIAC_NEW CMethod_behaviac_Agent_VectorClear());
			meta->RegisterMethod(3483755530u, BEHAVIAC_NEW CMethod_behaviac_Agent_VectorContains());
			meta->RegisterMethod(505785840u, BEHAVIAC_NEW CMethod_behaviac_Agent_VectorLength());
			...
			AgentMeta::Register<monster_id1>("monster_id1");
		...
		virtual bool unLoad()
		{
			...
			AgentMeta::UnRegister<monster_id1>("monster_id1");
